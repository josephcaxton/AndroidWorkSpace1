...
import com.learnersCloud.iEvaluator.Maths1500.R;
...
public class Customise extends ActivityGroup implements OnClickListener,OnSeekBarChangeListener {
	...
	private static final int MAXIMUMQUESTIONS = 1500;
	...
	public void onClick(View v) {
		...
		case(R.id.btnCustomise):
			...
			//Intent ChangeDifficultyIntent = new Intent("com.learnersCloud.iEvaluator.Maths1500.CHANGEDIFFICULTYACTIVITY");
			//TabGroupActivity parentActivity = (TabGroupActivity)getParent(); 
			//startActivity(ChangeDifficultyIntent);
			
			Intent CustomiseIntent = new Intent("com.learnersCloud.iEvaluator.Maths1500.CONFIGURE");
		...
		case(R.id.btnStartTest):
			...
			int AccessLevel = sharedPrefs.getInt("versionPref", 7);		
