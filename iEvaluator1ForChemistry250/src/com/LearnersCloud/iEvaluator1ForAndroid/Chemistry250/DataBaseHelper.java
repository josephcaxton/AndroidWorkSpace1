package com.LearnersCloud.iEvaluator1ForAndroid.Chemistry250;
...
public class DataBaseHelper extends SQLiteOpenHelper{
    ...
    private static String DB_PATH = "/data/data/com.LearnersCloud.iEvaluator1ForAndroid.Chemistry250/databases/";
...
public static void backupDatabase() throws IOException {
    //Open your local db as the input stream
    String inFileName = "/data/data/com.learnersCloud.iEvaluatorForAndroid.Chemistry/databases/TempDB.sqlite";
