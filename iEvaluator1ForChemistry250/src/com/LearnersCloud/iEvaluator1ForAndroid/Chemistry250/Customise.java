...
import com.LearnersCloud.iEvaluator1ForAndroid.Chemistry250.R;
...
public class Customise extends ActivityGroup implements OnClickListener,OnSeekBarChangeListener {
	...
	public void onClick(View v) {
		...
		case(R.id.btnCustomise):
			...
			//Intent ChangeDifficultyIntent = new Intent("com.LearnersCloud.iEvaluator1ForAndroid.Chemistry250.CHANGEDIFFICULTYACTIVITY");
			//TabGroupActivity parentActivity = (TabGroupActivity)getParent(); 
			//startActivity(ChangeDifficultyIntent);
			
			Intent CustomiseIntent = new Intent("com.LearnersCloud.iEvaluator1ForAndroid.Chemistry250.CONFIGURE");
