...
import com.LearnersCloud.iEvaluator1ForAndroid.Chemistry500.R;
...
public class Customise extends ActivityGroup implements OnClickListener,OnSeekBarChangeListener {
	...
	private static final int MAXIMUMQUESTIONS = 500;
	...
	public void onClick(View v) {
		...
		case(R.id.btnCustomise):
			...
			//Intent ChangeDifficultyIntent = new Intent("com.LearnersCloud.iEvaluator1ForAndroid.Chemistry500.CHANGEDIFFICULTYACTIVITY");
			//TabGroupActivity parentActivity = (TabGroupActivity)getParent(); 
			//startActivity(ChangeDifficultyIntent);
			
			Intent CustomiseIntent = new Intent("com.LearnersCloud.iEvaluator1ForAndroid.Chemistry500.CONFIGURE");
		...
		case(R.id.btnStartTest):
			...
			int AccessLevel = sharedPrefs.getInt("versionPref", 3);		
	...
	public void LoadQuestionViaTemplate(QuestionLookupItem item) {
		...
		case 3: // Multiple Choice Multiple Answer
