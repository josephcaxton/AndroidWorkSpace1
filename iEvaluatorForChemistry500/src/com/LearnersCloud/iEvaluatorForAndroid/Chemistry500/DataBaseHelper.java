package com.LearnersCloud.iEvaluatorForAndroid.Chemistry500;
...
public class DataBaseHelper extends SQLiteOpenHelper{
    ...
    private static String DB_PATH = "/data/data/com.LearnersCloud.iEvaluatorForAndroid.Chemistry500/databases/";
...
public static void backupDatabase() throws IOException {
    //Open your local db as the input stream
    String inFileName = "/data/data/com.LearnersCloud.iEvaluatorForAndroid.Chemistry500/databases/TempDB.sqlite";
