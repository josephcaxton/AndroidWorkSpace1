...
public class DataBaseHelper extends SQLiteOpenHelper{
    ...
    private static String DB_PATH = "/data/data/com.LearnersCloud.iEvaluatorForAndroid.Chemistry1000/databases/";
...
public static void backupDatabase() throws IOException {
    //Open your local db as the input stream
    String inFileName = "/data/data/com.learnersCloud.iEvaluatorForAndroid.Chemistry1000/databases/TempDB.sqlite";
