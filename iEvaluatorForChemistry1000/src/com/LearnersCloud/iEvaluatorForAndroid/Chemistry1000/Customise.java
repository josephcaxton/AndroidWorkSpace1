...
public class Customise extends ActivityGroup implements OnClickListener,OnSeekBarChangeListener {
	...
	private static final int MAXIMUMQUESTIONS = 1000;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		super.onCreate(savedInstanceState);
		 ...
		 NumberOfQuestions.setText("You selected" +  " " + "10" + " " + "Questions" + ", your search criteria return records and does not necessarily have all types of questions");
	...
	public void onClick(View v) {
		...
		case(R.id.btnCustomise):
			...
			//Intent ChangeDifficultyIntent = new Intent("com.LearnersCloud.iEvaluatorForAndroid.Chemistry1000.CHANGEDIFFICULTYACTIVITY");
			//TabGroupActivity parentActivity = (TabGroupActivity)getParent(); 
			//startActivity(ChangeDifficultyIntent);
			
			Intent CustomiseIntent = new Intent("com.LearnersCloud.iEvaluatorForAndroid.Chemistry1000.CONFIGURE");
