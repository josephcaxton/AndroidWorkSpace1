...
import com.LearnersCloud.iEvaluator1ForAndroid.Chemistry750.R;
...
public class Customise extends ActivityGroup implements OnClickListener,OnSeekBarChangeListener {
	...
	private static final int MAXIMUMQUESTIONS = 750;
	...
	public void onClick(View v) {
		...
		case(R.id.btnCustomise):
			...
			//Intent ChangeDifficultyIntent = new Intent("com.LearnersCloud.iEvaluator1ForAndroid.Chemistry750.CHANGEDIFFICULTYACTIVITY");
			//TabGroupActivity parentActivity = (TabGroupActivity)getParent(); 
			//startActivity(ChangeDifficultyIntent);
			
			Intent CustomiseIntent = new Intent("com.LearnersCloud.iEvaluator1ForAndroid.Chemistry750.CONFIGURE");
		...
		case(R.id.btnStartTest):
			...
			int AccessLevel = sharedPrefs.getInt("versionPref", 4);		
