...
public class Customise extends ActivityGroup implements OnClickListener,OnSeekBarChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		super.onCreate(savedInstanceState);
		 ...
		 NumberOfQuestions.setText("You selected" +  " " + "10" + " " + "Questions" + ", your search criteria and does not necessarily have all types of questions");
	...
	public void onClick(View v) {
		...
		case(R.id.btnCustomise):
			...
			//Intent ChangeDifficultyIntent = new Intent("com.learnersCloud.iEvaluatorForAndroid.Chemistry.CHANGEDIFFICULTYACTIVITY");
			//TabGroupActivity parentActivity = (TabGroupActivity)getParent(); 
			//startActivity(ChangeDifficultyIntent);
			
			Intent CustomiseIntent = new Intent("com.learnersCloud.iEvaluatorForAndroid.Chemistry.CONFIGURE");
