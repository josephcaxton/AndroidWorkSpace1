...
public class DataBaseHelper extends SQLiteOpenHelper{
    ...
    private static String DB_PATH = "/data/data/com.learnersCloud.iEvaluator.Maths500/databases/";
...
public static void backupDatabase() throws IOException {
    //Open your local db as the input stream
    String inFileName = "/data/data/com.learnersCloud.iEvaluator.Maths500/databases/TempDB.sqlite";
