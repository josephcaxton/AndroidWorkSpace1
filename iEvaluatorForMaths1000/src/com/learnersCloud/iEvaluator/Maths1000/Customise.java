...
import com.learnersCloud.iEvaluator.Maths1000.R;
...
public class Customise extends ActivityGroup implements OnClickListener,OnSeekBarChangeListener {
	...
	public void onClick(View v) {
		...
		case(R.id.btnCustomise):
			...
			//Intent ChangeDifficultyIntent = new Intent("com.learnersCloud.iEvaluator.Maths1000.CHANGEDIFFICULTYACTIVITY");
			//TabGroupActivity parentActivity = (TabGroupActivity)getParent(); 
			//startActivity(ChangeDifficultyIntent);
			
			Intent CustomiseIntent = new Intent("com.learnersCloud.iEvaluator.Maths1000.CONFIGURE");
		...
		case(R.id.btnStartTest):
			...
			int AccessLevel = sharedPrefs.getInt("versionPref", 5);		
