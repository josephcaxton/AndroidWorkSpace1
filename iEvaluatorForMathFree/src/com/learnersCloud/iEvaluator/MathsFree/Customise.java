...
public class Customise extends ActivityGroup implements OnClickListener,OnSeekBarChangeListener {
	...
	private static final int MAXIMUMQUESTIONS = 50;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		super.onCreate(savedInstanceState);
		 ...
		 NumberOfQuestions.setText("You selected" +  " " + "10" + " " + "Questions" + ", You are using the free version of this app. To unlock all questions filters and get unlimited access, buy the full version in store");
	...
	public void onClick(View v) {
		...
		case(R.id.btnCustomise):
			...
			//Intent CustomiseIntent = new Intent("com.learnersCloud.iEvaluator.MathsFree.CONFIGURE");
			//startActivity(CustomiseIntent);
			Toast.makeText(getBaseContext(),
	                "You are using the free version of this app. To unlock all questions filters and get unlimited access, buy the full version in store.",
	                Toast.LENGTH_LONG).show(); 
		...
		case(R.id.btnStartTest):
			...
			int AccessLevel = sharedPrefs.getInt("versionPref", 1);		
		    ...
		    // Access Level
		     sb.append(" and a.AccessLevel <= " + AccessLevel + " ");
